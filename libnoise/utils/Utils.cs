...
namespace noise.utils
{
    public static class Utils {
        ...
        const long X_NOISE_GEN = 1619;
        const long Y_NOISE_GEN = 31337;
        const long Z_NOISE_GEN = 6971;
        const long SEED_NOISE_GEN = 1013;
        const long SHIFT_NOISE_GEN = 8;

        static double[] RandomVectors = new double[256 * 4] {
        ...
        public static double GradientCoherentNoise3D (double x, double y, double z, long seed, NoiseQuality noiseQuality)
        {
        ...
        public static double GradientNoise3D (double fx, double fy, double fz, int ix, int iy, int iz, long seed)
        {
            ...
            vectorIndex ^= (vectorIndex >> (int)SHIFT_NOISE_GEN);
            vectorIndex &= 0xff;
        ...
        public static long IntValueNoise3D (long x, long y, long z, long seed)
        {
        ...
        public static double ValueCoherentNoise3D (double x, double y, double z, long seed, NoiseQuality noiseQuality)
        {
